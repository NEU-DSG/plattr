...
5. Ask me, @jbuckle, for the .vagrant version of the settings.php file that you'll need for the site to work, in addition to the SQL database dump that TAPAS requires.
